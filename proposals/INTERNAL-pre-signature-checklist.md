# Pre-signature checklist — INTERNAL

**Do not send this file to the client.** It was Schedule 4 of the Consulting
Agreement and was removed from the client-facing contract: a signed agreement
should not carry its own to-do list. The content is kept here because it is
still the working checklist for getting the contract executed.
